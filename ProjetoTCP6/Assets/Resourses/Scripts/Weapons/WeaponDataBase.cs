...
[CreateAssetMenu(menuName = "Inventory System/Weapon Database")]
public class WeaponDataBase : ScriptableObject
{
    [SerializeField] private List<WeaponData> _itemDatabase;

    public List<WeaponData> ItemDatabase => _itemDatabase;

    [ContextMenu("Set IDs")]
    public void SetItemIDs()
    {
        _itemDatabase = new List<WeaponData>();

        var foundItems = UnityEngine.Resources.LoadAll<WeaponData>("WeaponsData").OrderBy(i => i.ID).ToList();
    ...
    public WeaponData GetWeapon(string displayName)
    {
        return _itemDatabase.Find(i => i.weaponName == displayName);
    }
}
